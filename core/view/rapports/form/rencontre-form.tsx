    ...
    <Dialog open={open} onOpenChange={onOpenChangeAction}>
      <DialogContent className="!max-w-5xl max-h-[95vh] overflow-hidden p-0 border-none">
        <div className="flex h-full">
          {/* Sidebar avec les étapes - maintenant fixe */}
          <div className="w-80 bg-gradient-to-b from-slate-50 to-slate-100 border-r p-6 sticky top-0 h-[95vh] overflow-y-auto">
          ...
          <div className="flex-1 flex flex-col h-[95vh]">
            ...
            {/* Contenu du formulaire - maintenant scrollable */}
            ...
            {/* Footer avec navigation - maintenant sticky en bas */}
