...
import { useGetMyPlanning, useGetPlanning } from "@/core/hooks/use-planning";
import { Spinner } from "@/core/components/ui/spinner";

type Props = {
  disabled: boolean;
  id: string;
  onChangeValueAction: (value: { tourId: string; accompanimentId: string }) => void;
  userId: string;
};

export const SelectMyVisit = ({
  disabled,
  id,
  onChangeValueAction,
  userId,
...
const handleSelectChange = (value: string) => {
  ...
  const selectedTour = allTours.find((tour) => tour.id === value);
  if (selectedTour) {
    onChangeValueAction({
      tourId: selectedTour.id,
      accompanimentId: selectedTour.accompanimentId,
    });
  }
};
  return (
