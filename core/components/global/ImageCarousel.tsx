        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              aria-label={isAutoPlay ? "Mettre en pause" : "Lancer le diaporama"}
            >
                      ...
                      <>
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                          <div className="flex items-end justify-between">
                            <div>
                              <p className="text-sm font-medium text-emerald-300 mb-1">{description}</p>
                              <p className="text-3xl font-bold">Photo {index + 1}</p>
                            </div>
                          </div>
                        </div>
                      </>
